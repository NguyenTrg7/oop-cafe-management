...
void Customer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Customer::*)()>(_a, &Customer::loyaltyPointsChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Customer::*)()>(_a, &Customer::phoneNumberChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Customer::*)()>(_a, &Customer::rankChanged, 2))
            return;
    }
